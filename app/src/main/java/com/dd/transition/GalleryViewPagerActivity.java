...
public class GalleryViewPagerActivity extends FragmentActivity {
    ...
    private List<GalleryCommonFragment> fragments = new ArrayList<>(); // 供ViewPager使用
    ...
    private void fillViewPager() {
        ...
        for (int i = 0; i < 10; i++) {
            // 预先准备10个fragment
            fragments.add(new GalleryCommonFragment());
        }

        viewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            @Override
            public Fragment getItem(int position) {
                GalleryCommonFragment fragment = fragments.get(position % 10);
